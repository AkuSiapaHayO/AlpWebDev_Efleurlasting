                    ...
                    <div class="card-body">
                        <div class="row gx-5 mb-4">
                            <div class="col-md-3 mb-3">
                                ...
                                <p class="card-text">Edit your profile according to your preferences. Make a cool username.
                                    Also
                                ...
                                <p class="card-text">Edit your Address as <span class="text-danger">detail</span> as
                                    possible in
                                ...
                                <p class="card-text">Update your password associated with your account. And make sure to
                                    <span class="text-danger">remember</span> it!</p>
                            </div>
                            <div class="col-md-9">
