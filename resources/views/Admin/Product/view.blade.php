                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <a href="{{ route('colors.view') }}" class="card-link">
                                            <button class="btn btn btn-pink-color text-white fw-bold">Manage Colors</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col mb-4">
                            <div class="card h-100 shadow-lg new" style="transition: 0.3s; border-radius: 7px;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text fs-5">{{ $product->is_active ? 'Product is Active' : 'Product is Inactive' }}</p>
